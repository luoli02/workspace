...
public class TransactionConsumerClient {
    ...
    @Autowired
    private TransactionListenerDemo transactionListenerDemo;
    ...
    public ConsumerBean transactionConsumer() {
        ...
        subscriptionTable.put(subscription, transactionListenerDemo);
